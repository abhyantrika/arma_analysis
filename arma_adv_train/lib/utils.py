...
def adjust_learning_rate(initial_lr, optimizer, epoch, n_repeats,adjust_epoch_factor=30.0):
    """Sets the learning rate to the initial LR decayed by 10 every 30 epochs"""
    lr = initial_lr * (0.1 ** (epoch // int(math.ceil(adjust_epoch_factor/n_repeats))))
