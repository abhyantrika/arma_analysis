...
def parse_args():
    ...
    parser.add_argument('--model',default='res',help='res or vgg arma')
    parser.add_argument('--adj_lr_factor',default=30,type=float,help='epochs to drop lr by 10.')

    parser.add_argument('--full_epoch',default=False,type=bool,help='disable epoch limit')
