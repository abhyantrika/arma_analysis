...
def main(args):
    ...
    model = model_map[model_type](arma=True,num_classes=args.n_classes)
    ...
    #Load dataloaders
    augmentations = aug.Compose([aug.RandomCrop(512),aug.RandomHorizontallyFlip(5),aug.Jitter()])
