...
class Resnet18_8s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 8
        resnet18_8s = resnet.resnet18(fully_conv=True,
                                      pretrained=True,
                                      output_stride=8,
                                      remove_avg_pool_layer=True)
...
class Resnet18_16s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        resnet18_16s = resnet.resnet18(fully_conv=True,
                                      pretrained=True,
                                      output_stride=16,
                                      remove_avg_pool_layer=True)
...
class Resnet18_32s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 8
        resnet18_32s = resnet.resnet18(fully_conv=True,
                                       pretrained=True,
                                       output_stride=32,
                                       remove_avg_pool_layer=True)
...
class Resnet34_16s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 8
        resnet34_16s = resnet.resnet34(fully_conv=True,
                                       pretrained=True,
                                       output_stride=16,
                                       remove_avg_pool_layer=True)
...
class Resnet34_8s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 8
        resnet34_8s = resnet.resnet34(fully_conv=True,
                                       pretrained=True,
                                       output_stride=8,
                                       remove_avg_pool_layer=True)
...
class Resnet50_32s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 8
        resnet50_32s = resnet.resnet50(fully_conv=True,
                                       pretrained=True,
                                       output_stride=32,
                                       remove_avg_pool_layer=True)
...
class Resnet50_16s(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # Load the pretrained weights, remove avg pool
        # layer and get the output stride of 16
        resnet50_8s = resnet.resnet50(fully_conv=True,
                                       pretrained=True,
                                       output_stride=16,
                                       remove_avg_pool_layer=True)
...
if __name__ == '__main__':
   model = Resnet18_32s(num_classes=10)

   import torch;
   inp = torch.rand(10,3,200,200)
