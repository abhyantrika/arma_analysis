...
from model.faster_rcnn import resnet_arma
...
#lth
  ...
  parser.add_argument('--use_imagenet_pretrained',default=False,type=bool,help='Use imagenet pretrained')
  parser.add_argument('--arma',default=False,type=bool,help='Use arma resnet')
...
if __name__ == '__main__':
  ...
  if args.pretrained_path:
    ...
    pretrain_string = args.pretrained_path
  ...
  #   input_dir += f"_bs{args.batch_size}_lr{args.lr}_lrds{args.lr_decay_step}_"+\
  ...
  elif (args.net == 'res18' and args.arma==True):
        print('ARMA resnet18')
        fasterRCNN = resnet_arma.resnet(imdb.classes, 18, pretrained=False, class_agnostic=args.class_agnostic, \
                        pretrained_path=args.pretrained_path)       
  elif (args.net == 'res18' and args.arma==False):
        print('base resnet18')
        fasterRCNN = resnet(imdb.classes, 18, pretrained=args.use_imagenet_pretrained, class_agnostic=args.class_agnostic, \
                        pretrained_path=args.pretrained_path)
  ...
  # if os.path.exists(os.path.join(save_name,"results")):
  #   quit()
